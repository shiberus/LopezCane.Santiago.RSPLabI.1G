...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    ...
    if(this != NULL && nodeIndex >= 0 && nodo != NULL)
    {
...
/** \brief Por cada de la lista llama a una funcion pasandole el pElement
 ...
 */
int ll_forEach(LinkedList* this, int (*pFunc)(void*))
{
    Node* nodo = NULL;
    int todoOk = -1;
...
/** \brief Por cada elemento de la lista llama a una pFunc pasandole el pElement
 * y añade el retorno de la funcion a una nueva lista en cada iteracion
 * 
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion que se quiere aplicar
 * \return una nueva linked list producto de pasar cada elemento de la original por pFunc
 */
LinkedList* ll_map(LinkedList* this, void* (*pFunc)(void*))
{
    ...
    if (this != NULL && nuevaLista != NULL)
    {
        ...
        while (nodo != NULL)
        {
            ll_add(nuevaLista, (*pFunc)(nodo->pElement));
...
/** \brief Crea una lista con los elementos cuando la funcion criterio recibida como parametro retorna (1)
 * \param pList LinkedList* Puntero a la lista
